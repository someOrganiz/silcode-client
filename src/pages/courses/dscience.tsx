...
export default function DScience() {
  return (
    <main>
      ...
      <Suitables propsList={suitableProps} />
    </main>
  );
}
...
const abilitiesProps = [
  {
    title: "Основы программирования на Python + Python для анализа данных",
    p1: "Основы программирования на Python + Анализ данных в Pandas и NumPy. Работа c файлами, HTML-страницами и API",
  },
  {
    title: "Разведывательный анализ данных",
    p1: "Разведывательный анализ с помощью Pandas, Numpy. Основы статистики и проверка статистических гипотез. ML-эксперименты. ",
  },

  {
    title: "Подгрузка данных",
    p1: "Выгрузка данных из разных источников с помощью Python. Выгрузка баз данных с помощью SQL. Выбор подходящих данных для решения задач.",
  },

  {
    title: "Математика и углубленное машинное обучение",
    p1: "Линейная алгебра. Основы теории вероятности. Основные модели машинного обучения. Оценка качества алгоритмов.",
  },
  {
    title: "ML",
    p1: "Задачи классификации, регрессии и кластеризации. Отбор и селекция признаков. Валидация данных. Оптимизация гиперпараметров и улучшение качества модели.",
  },
];
...
const suitableProps = [
  {
    image:
      "https://248006.selcdn.ru/LandGen/desktop_2_3b9ecd1df00039e329fa8bb42353ae945e34bcae.webp",
    title: "Новичкам",
  ...
  {
    image:
      "https://248006.selcdn.ru/LandGen/desktop_2_5e672af2a4b64969b0586e18796e857129919880.webp",
  ...
  {
    image:
      "https://248006.selcdn.ru/LandGen/desktop_2_c2ce682107ea8965004d75b1ebcee50999d287b5.webp",
